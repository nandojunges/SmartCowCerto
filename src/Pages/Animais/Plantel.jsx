...
export default function Plantel({ isOnline = navigator.onLine }) {
  ...
  // Estilos modernos
  const styles = {
    page: { padding: "24px", backgroundColor: "#f8fafc", minHeight: "100vh", fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif" },
    container: { maxWidth: "1400px", margin: "0 auto" },
    card: { backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #e2e8f0", boxShadow: "0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)", overflow: "hidden" },
    header: { padding: "24px 24px 0", borderBottom: "1px solid #f1f5f9", marginBottom: "16px" },
    title: { fontSize: "20px", fontWeight: 700, color: "#0f172a", margin: "0 0 4px" },
    subtitle: { fontSize: "14px", color: "#64748b", margin: 0 },
    hint: { padding: "0 24px 16px", fontSize: "13px", color: "#64748b", fontStyle: "italic" },
    tableContainer: { overflowX: "auto" },
    table: { width: "100%", borderCollapse: "separate", borderSpacing: 0, fontSize: "14px" },
    th: { padding: "14px 16px", textAlign: "left", fontSize: "11px", fontWeight: 700, color: "#475569", textTransform: "uppercase", letterSpacing: "0.05em", borderBottom: "2px solid #e2e8f0", backgroundColor: "#f8fafc", whiteSpace: "nowrap", userSelect: "none" },
    ...
    animalCell: { display: "flex", alignItems: "center", gap: "12px" },
    animalNum: { width: "40px", height: "40px", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#eff6ff", color: "#1e40af", borderRadius: "10px", fontWeight: 700, fontSize: "14px", flexShrink: 0 },
    animalInfo: { display: "flex", flexDirection: "column", gap: "2px" },
    animalTitle: { fontWeight: 600, color: "#0f172a", fontSize: "14px" },
    animalSub: { fontSize: "13px", color: "#64748b", display: "flex", alignItems: "center", gap: "6px" },
    dot: { color: "#cbd5e1" },
    num: { fontFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace", fontWeight: 600 },
    actionBtn: { padding: "6px 12px", backgroundColor: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "6px", fontSize: "13px", fontWeight: 500, color: "#374151", cursor: "pointer", transition: "all 0.2s", "&:hover": { backgroundColor: "#f1f5f9", borderColor: "#cbd5e1" } },
      ...
      <div style={styles.container}>
        ...
        <div style={styles.card}>
          <div style={styles.header}>
            <h2 style={styles.title}>Plantel</h2>
            <p style={styles.subtitle}>Gestão completa do rebanho e status produtivo</p>
          </div>

          <div style={styles.hint}>
            Dica: clique no título da coluna para ordenar/filtrar. Clique novamente para fechar.
          </div>
