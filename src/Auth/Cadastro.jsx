...
// ✅ Componente de Input Reutilizável com Ícone (MOVIDO PARA FORA DO Cadastro)
function InputField({
  label,
  name,
  type = "text",
        ...
        {Icon && (
          <Icon
            ...
            style={{
              ...
              zIndex: 2,
              pointerEvents: "none", // ✅ nunca captura clique/foco
            }}
          />
        )}
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, rgba(15,23,42,0.4) 0%, rgba(0,0,0,0.2) 100%)",
      ...
      >
        ...
        >
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    transition: "all 0.3s",
                    backgroundColor:
                      focusedField === "senha" ? "#ffffff" : "#f9fafb",
                    boxShadow:
                      focusedField === "senha"
                        ? "0 0 0 4px rgba(21,101,192,0.1)"
                        : "none",
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    transition: "all 0.3s",
                    backgroundColor:
                      focusedField === "confirmar" ? "#ffffff" : "#f9fafb",
                    boxShadow:
                      focusedField === "confirmar"
                        ? "0 0 0 4px rgba(21,101,192,0.1)"
                        : "none",
          ...
          <motion.button
            ...
            whileHover={{
              scale: 1.02,
              boxShadow: "0 20px 40px -10px rgba(21,101,192,0.4)",
            }}
            whileTap={{ scale: 0.98 }}
            style={{
